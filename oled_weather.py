...
#mengambil data dari ubidots#u = urequests.get("http://things.ubidots.com/api/v1.6/variables/57aa925876254248aaccd93f/values/?page_size=2&token=Rykf3N1k8RgtBrQ393TBCk03RwhQrfPIIVkeUlFqlLeCLCkTVkt01zeHUNGB").json()
